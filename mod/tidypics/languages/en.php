...
$english = array(
		...
		// Menu items and titles
            ...
            'images:flickr' => "Import from Flickr",  // Added By Rijo Joy for Flickr
			'images:flickr_import_settings' => "Settings",   // Added By Rijo Joy for Flickr
			'images:flickr_import_photos' => "Import Photos", // Added By Rijo Joy for Flickr
			'flickr:intro' => "<strong>Save Flickr Settings to Import Photo Sets from Flickr</strong>",
			'flickr:usernamesetup' => "Flickr Username:",
			'flickr:albumdesc' => "Select Album:",
			'flickr:selectalbum' => "Please Select album to import flickr photosets",
